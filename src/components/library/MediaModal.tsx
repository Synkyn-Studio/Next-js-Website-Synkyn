  ...
  return (
    <div id="media-modal" className="media-modal" data-lenis-prevent="" aria-hidden="true" role="dialog" aria-modal="true" aria-labelledby="modal-title">
      <div className="media-modal__card" id="modal-content-wrapper">
        <button id="close-modal" className="media-modal__close" aria-label="Close">
        ...
        <div className="media-modal__media-wrapper">
          ...
          <button id="modal-prev-btn" className="media-modal__nav-btn media-modal__nav-btn--prev" aria-label="Previous">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
              <path d="M15 18l-6-6 6-6" />
            </svg>
          </button>
          <button id="modal-next-btn" className="media-modal__nav-btn media-modal__nav-btn--next" aria-label="Next">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
